...
import (
	...
	"github.com/Papiitooo/Bitch-core/crypto/signify"
	"github.com/Papiitooo/Bitch-core/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/Papiitooo/Bitch-core/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/Papiitooo/Bitch-core/mobile")
