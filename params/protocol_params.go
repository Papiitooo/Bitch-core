...
var (
	DifficultyBoundDivisor = big.NewInt(100)   // The bound divisor of the difficulty, used in the update calculations.
	GenesisDifficulty      = big.NewInt(10000000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(10000000) // The minimum that the difficulty may ever be.
