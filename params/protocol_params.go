...
var (
	...
	GenesisDifficulty      = big.NewInt(2000000000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(2000000000) // The minimum that the difficulty may ever be.
